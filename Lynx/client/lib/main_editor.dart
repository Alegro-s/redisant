...
import 'package:client/app/router_editor.dart';
...
void main() async {
  ...
  final GoRouter router = createEditorRouter(auth);
  ...
  runApp(_NexusEditorApp(authProvider: auth, router: router));
...
class _NexusEditorApp extends StatelessWidget {
  final AuthProvider authProvider;
  final GoRouter router;
  const _NexusEditorApp({required this.authProvider, required this.router});
